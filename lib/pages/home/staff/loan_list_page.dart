...
class _LoanListPageState extends State<LoanListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Danh sách khoản vay'), elevation: 1),
      body: SafeArea(
                  ...
                  builder: (context, snap) {
                    ...
                    if (filtered.isEmpty) {
                      if (q.isEmpty) {
                        return _buildEmpty(
                          'Chưa có khoản vay',
                          'Chưa có dữ liệu khoản vay để hiển thị.',
                          onAction: () {
                            setState(() => _refreshKey++);
                          },
                          actionLabel: 'Làm mới',
                        ...
                        return _buildEmpty(
                          ...
                          'Thử xóa từ khóa tìm kiếm hoặc kiểm tra lại ID.',
                          onAction: () {
                            _searchCtrl.clear();
                            setState(() => _query = '');
                          },
