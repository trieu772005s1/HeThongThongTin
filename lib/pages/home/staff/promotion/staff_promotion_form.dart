...
import 'package:fl_credit/models/promotion.dart';
...
class _AdminPromotionFormState extends State<AdminPromotionForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEdit ? "Chỉnh sửa ưu đãi" : "Thêm ưu đãi")),
      body: ListView(
  ...
  Future<void> _save() async {
    if (titleCtrl.text.isEmpty ||
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Điền đủ thông tin")));
      return;
    }
